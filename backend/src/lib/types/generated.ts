...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  updateGlobalRankForMonster?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType, RequireFields<MutationUpdateGlobalRankForMonsterArgs, 'monsterDrinkName' | 'userRank'>>;
};
