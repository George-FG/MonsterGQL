...
export type Mutation = {
  __typename?: 'Mutation'
  updateGlobalRankForMonster?: Maybe<Scalars['Float']['output']>
}

export type MutationUpdateGlobalRankForMonsterArgs = {
  monsterDrinkName: Scalars['String']['input']
  userRank: Scalars['Int']['input']
}
...
> = {
  updateGlobalRankForMonster?: Resolver<
    Maybe<ResolversTypes['Float']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateGlobalRankForMonsterArgs, 'monsterDrinkName' | 'userRank'>
  >
}
...
> = {
  ...
  >
  getUsersRankedMonsters?: Resolver<
    Array<Maybe<ResolversTypes['MonsterDrink']>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetUsersRankedMonstersArgs, 'userId'>
  >
